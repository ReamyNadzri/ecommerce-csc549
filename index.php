...
// Using '$conn' from your connection.php file
$result = $conn->query($sql); //

// This is where we will store our neatly structured product data
$products = []; //

if ($result && $result->num_rows > 0) {
    // Loop through each row from the database
    while ($row = $result->fetch_assoc()) { //
        // NOW, we build the structured array for each product
        // and add it to our main $products array.
        $products[] = array(
                                        ...
                                        <form method="get" action="items.php">
                                            ...
                                            <a href="javascript:;" onclick="this.closest('form').submit();" style="text-decoration: none; color: inherit;">
                                                <div class="food-image-container">
                                                    <img src="<?php echo htmlspecialchars($product['ImagePath']); ?>" alt="<?php echo htmlspecialchars($product['Flavour']); ?>" class="food-image card-img-top">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="food-price mb-1">
                                                        RM <?php echo htmlspecialchars($product['PriceMYR']); ?>
                                                    </div>
