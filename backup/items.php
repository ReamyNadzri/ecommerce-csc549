            ...
            <div class="row mt-2 ">
                <div class="col-md-5 product-image-container">
                    ...
                    <div class="thumbnail-container row mt-4">
                        ...
                        <div class="col">
                            <img src="sources/nutrisinasiasam.webp" class="img-thumbnail" width="130" onclick="changeImage('sources/nutrisinasiasam.webp')" alt="Image 2">
                        </div>
                        <div class="col">
                            <img src="sources/nutrisinasikari.webp" class="img-thumbnail" width="130" onclick="changeImage('sources/nutrisinasikari.webp')" alt="Image 2">
                        </div>
                        <div class="col">
                        ...
                        <form id="orderForm">
                            ...
                            <div class="row mb-3 w3-margin-left">
                                ...
                                <div id="eWalletOptions" class="col-12 mt-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment" id="eWalletDuitNow" value="duit_now" onclick="showQRCode('sources/qrduitnow.jpg')">
                                    ...
                                    <div id="qrCodeContainer" class="mt-3" style="display: none;">
                                        ...
                                        <a href="https://payment.tngdigital.com.my/sc/bDLn8K4vWL" class="tng-button">
                                            <div class="tng-logo">
                                                <img src="sources/tng.png" alt="Touch 'n Go eWallet Logo" style="width: 35px;">
                                            </div>
                                            <span class="tng-text">Pay with Touch 'n Go eWallet</span>
                                        </a>
                                    ...
                                    <script>
                                        ...
                                        alert('Please upload the payment proof after making the online payment.');
